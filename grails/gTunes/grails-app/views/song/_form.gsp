...
<div class="fieldcontain ${hasErrors(bean: songInstance, field: 'releasedAt', 'error')} required">
	<label for="releasedAt">
		<g:message code="song.releasedAt.label" default="Released At" />
		<span class="required-indicator">*</span>
	</label>
	<g:datePicker name="releasedAt" precision="day"  value="${songInstance?.releasedAt}"  />
