	...
	<body>
		...
		<div id="show-song" class="content scaffold-show" role="main">
			...
			<ol class="property-list song">
				...
				<g:if test="${songInstance?.releasedAt}">
				<li class="fieldcontain">
					<span id="releasedAt-label" class="property-label"><g:message code="song.releasedAt.label" default="Released At" /></span>
					
						<span class="property-value" aria-labelledby="releasedAt-label"><g:formatDate date="${songInstance?.releasedAt}" /></span>
